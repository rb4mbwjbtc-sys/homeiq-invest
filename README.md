# HomeIQ Independent V4.2 – Federated Swiss Data Gateway

V4.2 baut technisch auf V3.1 auf und ersetzt die Idee einer selbst zu pflegenden Schweizer Voll-Datenbank durch eine föderierte Quellenarchitektur.
...
ESTV ist in der Quellenmatrix vorgesehen. V4.2 verwendet bewusst keinen undokumentierten Webseiten-Scraper für den Steuerrechner.
...
Diese Adapter sind in V4.2 bewusst deaktiviert, solange kein offizieller API-/Lizenzzugang besteht. Es wird kein automatisiertes Scraping eingebaut.
...
Wie bisher über GitHub → Vercel. Es sind für V4.2 keine neuen Environment Variables erforderlich.


## V4.2 – Reliable Location Data
