    ...
    <div className="page-stack result-page">
      ...
      <div className="screen-report">
        <section className="result-hero report-cover">
          <div>
            <span className="eyebrow">HOMEIQ INVEST · ANALYSEBERICHT V4.7</span>
            <h1>{input.title}</h1>
            <p>
      ...
      <article className="print-report">
        <header className="print-header">
          <div>
            <div className="print-brand"><img src={homeIqLogo} alt="HomeIQ"/><span>HOMEIQ INVEST · ANALYSE-BERICHT V4.7</span></div>
            <h1>{input.title}</h1>
            <p>
              {input.street} {input.postalCode} {input.city}
            </p>
